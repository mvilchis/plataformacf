            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarSecondCollapse">
                 <ul class="nav navbar-nav navbar-right " role="navigation">
                        <li>                             <a aria-label="Ir al catalogo de datos" title="Ir al catalogo de datos" href="http://datos.gob.mx/busca"  style="font-size:16px;">Explora</a>                         </li>
                        <li>                             <a aria-label="Conoce el impacto de los datos" title="Conoce el impacto de los datos" href="http://datos.gob.mx/blog"  style="font-size:16px;">Indicadores</a>                         </li>
                        <li>                             <a aria-label="Conoce los Datos Abiertos más buscados" target="_self" title="Conoce los Datos Abiertos más buscados" href="http://datos.gob.mx/visualizacion"  style="font-size:16px;">Acerca</a>                         </li>
                     </ul>
                  </div>
               </div>
            </nav>
         ...
         <div class="container">
            <div class="row">
               <section class="col-xs-12 col-sm-6">
                  <div class="region region-section-button-left">
                     <section id="block-block-2" class="block block-block clearfix">
                        <div onmousedown="window.location.href=&#39;/explora&#39;" class="explora-link">
                           <center>
                              <div class="section-button-image"><img src="sites/all/themes/tweme/assets/explora.png"></div>
                           </center>
                           <div class="section-button-label">Explora</div>
                           <div class="section-button-caption">Conoce y analiza los objetivos y sus indicadores</div>
                        </div>
                     </section>
                     <!-- /.block -->
                  </div>
               ...
               <section class="col-xs-12 col-sm-6">
                  <div class="region region-section-button-right">
                     <section id="block-block-3" class="block block-block clearfix">
                        <div onmousedown="window.location.href=&#39;/compara&#39;" class="compara-link">
                           <center>
                              <div class="section-button-image"><img src="sites/all/themes/tweme/assets/compara.png"></div>
                           </center>
                           <div class="section-button-label">Compara</div>
                           <div class="section-button-caption">Analiza la relación entre indicadores</div>
                        </div>
                     </section>
                     <!-- /.block -->
                  </div>
