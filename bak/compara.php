...
<script src='/js/geom/nacion.json'></script>
<script src='/js/geom/entidad.json'></script>
<script src='/js/geom/municipio.json'></script>
<?php
	$page = "compara";
	// Local functions
?>
