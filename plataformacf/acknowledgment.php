<section class="acknowledgment" id="acknowledgment">
  <h4><b> Con apoyo de: </b></h4>
        ...
        <td>
          <div class="item">
              <a href="https://www.inadem.gob.mx" target="_blank">
                <img src="img/acknowledgment/Inadem.png" alt="INADEM">
              </a>
          </div>
        </td>
        <td>
          <div class="item">
            <a href="http://pegaso.anahuac.mx/idearse" target="_blank">
              <img src="img/acknowledgment/Idea.png" alt="Idearse">
            </a>
          </div>
        </td>
        <td>
