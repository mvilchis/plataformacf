...
<body>
  ...
  <div class="container" style="padding-top:60px;">
    <div class="col-sm-12 texto_parrafo" property="content:encoded">
    <h2>¿Quién es Crowdfunding México?</h2>
    <div class="">
    ...
    <h2>¿Cómo funciona Crowdfunding México?</h2>
    <div class="">
    ...
    <h2>Aceleración del ecosistema de financiamiento colectivo</h2>
    <div class="">
    ...
    <h2>Beneficios del Crowdfunding México</h2>
    </div>
