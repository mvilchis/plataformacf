...
<html lang="es" class="no-js js gr__localhost">
   <head profile="http://www.w3.org/1999/xhtml/vocab">
      ...
      <link rel="canonical" href="acerca.php">
      <title>Acerca | Objetivos de Desarrollo Sostenible</title>
      <!--                          Style                                    -->
      <link type="text/css" rel="stylesheet" href="css/system.base.css" media="all">
            ...
            <div class="region region-content">
              <section id="block-system-main" class="block block-system clearfix">
                <div id="node-5" class="node node-page clearfix" about="/acerca" typeof="foaf:Document">
                  <span property="dc:title" content="Acerca" class="rdf-meta element-hidden"></span>
